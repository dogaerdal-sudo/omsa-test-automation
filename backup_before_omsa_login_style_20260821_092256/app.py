...
def require_login() -> None:
    ...
    if logo_path.exists():
        ...
        logo_html = (
            ...
            f'style="width:190px;max-height:70px;object-fit:contain;margin-bottom:20px;">'
        )
    ...
    st.markdown(
        ...
        .omsa-login-wrap {
            ...
            border-top: 5px solid #3e969f;
            padding: 34px 38px 30px 38px;
            box-shadow: 0 4px 18px rgba(20,52,74,.08);
        }
        .omsa-login-title {
            font-size: 24px;
            font-weight: 750;
    ...
    with center:
        st.markdown(
            f"""
            <div class="omsa-login-wrap">
                {logo_html}
                <div class="omsa-login-title">OMSA Test Automation</div>
                <div class="omsa-login-subtitle">
