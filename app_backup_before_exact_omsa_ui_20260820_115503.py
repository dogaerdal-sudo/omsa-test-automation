...
.Run / Configure Control-btn {display:inline-block;background:var(--blue);color:#fff!important;text-decoration:none!important;padding:5px 20px;border-radius:4px;font-size:12px;min-width:74px;text-align:center;}
.Run / Configure Control-btn:hover {background:var(--blue-hover);}
